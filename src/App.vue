                  ...
                  <div class="dropdown">
                    ...
                    >
                      <router-link
                        ...
                        >Psi</router-link
                      >
                      <router-link v-else class="nav-link" to="/en/animals/dogs"
                        >Dogs</router-link
                      >
                      ...
                      <router-link
                        ...
                        >Mačke</router-link
                      >
                      <router-link v-else class="nav-link" to="/en/animals/cats"
                        >Cats</router-link
                      >
                    </div>
                  </div>
...
export default {
  ...
  watch: {
    $route() {
      this.lang = this.$route.fullPath.split("/")[1];
      if (this.lang == "") this.lang = "sr";
      this.user = localStorage.getItem("currentUser") ? localStorage.getItem("currentUser") : "";
    },
  },
};
</script>
